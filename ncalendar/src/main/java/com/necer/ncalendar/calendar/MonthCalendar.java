...
public class MonthCalendar extends CalendarPager implements OnClickMonthViewListener {
    ...
    protected CalendarAdapter getCalendarAdapter() {
        ...
        MonthAdapter monthAdapter = new MonthAdapter(getContext(), mPageSize, mCurrPage, mInitialDateTime, this);
    ...
    protected void initCurrentCalendarView(int position) {
        ...
        if (lastPosition == -1) {
            ...
            if (onMonthCalendarChangedListener != null) {
                String shiftWork = currView.dateTimeShiftWork(mSelectDateTime);
                onMonthCalendarChangedListener.onMonthCalendarChanged(mSelectDateTime,shiftWork);
            }
    ...
    protected void setDateTime(DateTime dateTime) {
        ...
        if (onMonthCalendarChangedListener != null) {
            String shiftWork = currectMonthView.dateTimeShiftWork(mSelectDateTime);
            onMonthCalendarChangedListener.onMonthCalendarChanged(mSelectDateTime,shiftWork);
        }
    ...
    @Override
    public void onClickCurrentMonth(DateTime dateTime,String shiftWork) {
        dealClickEvent(dateTime, getCurrentItem());
    }

    @Override
    public void onClickLastMonth(DateTime dateTime,String shiftWork) {
        int currentItem = getCurrentItem() - 1;
        dealClickEvent(dateTime, currentItem);
    }

    @Override
    public void onClickNextMonth(DateTime dateTime,String shiftWork) {
        int currentItem = getCurrentItem() + 1;
        dealClickEvent(dateTime, currentItem);
    }
    ...
    private void dealClickEvent(DateTime dateTime, int currentItem) {
        ...
        if (onMonthCalendarChangedListener != null) {
            String shiftWork = nMonthView.dateTimeShiftWork(mSelectDateTime);
            onMonthCalendarChangedListener.onMonthCalendarChanged(dateTime,shiftWork);
        }
    }
