...
public class NCalendar extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener, OnWeekCalendarChangedListener, OnMonthCalendarChangedListener {
    ...
    @Override
    public void onWeekCalendarChanged(DateTime dateTime,String shiftWork) {
        if (STATE == WEEK) {
            monthCalendar.setDateTime(dateTime);
            requestLayout();
            if (onCalendarChangedListener != null) {
                onCalendarChangedListener.onCalendarChanged(dateTime,shiftWork);
            }
        }
    }

    @Override
    public void onMonthCalendarChanged(DateTime dateTime,String shiftWork) {
