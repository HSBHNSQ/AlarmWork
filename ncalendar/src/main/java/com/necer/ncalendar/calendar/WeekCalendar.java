...
public class WeekCalendar extends CalendarPager implements OnClickWeekViewListener {
    ...
    protected CalendarAdapter getCalendarAdapter() {
        ...
        WeekAdapter weekAdapter = new WeekAdapter(getContext(), mPageSize, mCurrPage,
                mInitialDateTime, this);
        return weekAdapter;
    }
    ...
    protected void initCurrentCalendarView(int position) {
        ...
        if (lastPosition == -1) {
            ...
            if (onWeekCalendarChangedListener != null) {
                ...
                onWeekCalendarChangedListener.onWeekCalendarChanged(mSelectDateTime,shiftWork);
            }
    ...
    protected void setDateTime(DateTime dateTime) {
        ...
        if (onWeekCalendarChangedListener != null) {
            String shiftWork = currectWeekView.dateTimeShiftWork(mSelectDateTime);
            onWeekCalendarChangedListener.onWeekCalendarChanged(mSelectDateTime,shiftWork);
        }
    }
    ...
    @Override
    public void onClickCurrentWeek(DateTime dateTime,String shiftWork) {
        ...
        lastSelectDateTime = dateTime;
        if (onWeekCalendarChangedListener != null) {
            onWeekCalendarChangedListener.onWeekCalendarChanged(dateTime,shiftWork);
        }
